                ...
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            >
                                {selectedFile ? (
                                    <div className="file-preview" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', width: '100%', textAlign: 'center' }}>
                                        <span className='dropzone__icon' style={{ color: '#4a90e2' }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                        </span>
                                        <p className='dropzone__title' style={{ color: '#e6edf3', wordBreak: 'break-all' }}>{selectedFile.name}</p>
                                        <p className='dropzone__subtitle' style={{ color: '#7d8590' }}>{(selectedFile.size / (1024 * 1024)).toFixed(2)} MB</p>
                                        <button 
                                            type='button'
                                            onClick={(e) => {
                                                e.preventDefault()
